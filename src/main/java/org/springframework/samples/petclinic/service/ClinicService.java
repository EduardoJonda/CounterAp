...
public interface ClinicService {
	...
	//logeo
	Login findAddress(String address)throws DataAccessException;
	
	//reporte
	Collection<Reporte> findAllReportes() throws DataAccessException;
	...
	// paginacion
	Page<Reporte> findReporteByEstadoPages(Pageable pageable) throws DataAccessException;

...
public class ReporteRestController {
	...
	// paginacion 
	@RequestMapping(value = "/reportes/estado/pendiente/list", method = RequestMethod.GET)
	Page<Reporte> getReportePendiente(Pageable pageable) {
		System.out.println("Peticion de pageable ");
		return this.clinicService.findReporteByEstadoPages(pageable);
	}
